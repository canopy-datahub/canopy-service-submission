...
import org.canopyplatform.canopy.submissionservice.mappers.UploadMapper;
import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;

import static org.canopyplatform.canopy.submissionservice.models.Constants.STUDY_PROP_HAS_DATAFILES;
...
public class DataFileService {
	...
	public UploadFilesDTO getUploadedFiles(Integer submissionId) {
        ...
        studiesDto.setCenter("(" + studyId + ") " + studiesDto.getCenter());
